...
/*V0.02
    -Replaced static objects with global class instance variable (see MasterNotes)
    -HOPE TO make this slightly more straightforward and less retarded
...
//NOT SURE: Do I want the doors themselves or their hinges to be the ones that know the light info? Probably the hinges, since those are what will be rotating anyway. And lights will be instantiated as children of the hinge (probably)
