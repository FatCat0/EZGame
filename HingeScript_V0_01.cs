...
//Hinge GO location will also probably determine the location of [Way to finish your thoughts!]


public class HingeScript_V0_01 : MonoBehaviour
{
    ...
    public int numStates, currentState;//How many/current rotation state(s) a given door has. Usually 1 (0 = closed, 1 = open), might be more in later levels
    ...
    //MAKE A DICTIONARY/ARRAY, ALSO MAKE PRIVATE
    ...
    */
    ...
    void Update()
    {
        /*if (test && Time.time > 1 && Time.time < 2)
        {
            OpenSesame();
            test = false;
        }
